...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-532174:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-532174:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oa1qqtq00SAXWH6O357';
    const issuer = 'https://dev-532174.okta.com/oauth2/default';
